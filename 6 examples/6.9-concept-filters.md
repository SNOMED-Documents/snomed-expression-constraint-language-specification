...
Module filters enable an expression constraint to match on only those concepts that belong to a specified module[^1] . Module filters use the keyword "moduleId" with a concept reference that is < [900000000000443000 |Module|](http://snomed.info/id/900000000000443000) .
