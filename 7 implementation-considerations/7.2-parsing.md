...
Please note, the ABNF syntax defined in this specification was tested using the APG Parser Generator[1](https://confluence.ihtsdotools.org/display/DOCECL/7.2+Parsing#Footnote1 "Footnote: Click here to display the footnote") .
...
Footnotes Ref | Notes  
---|---  
[1](https://confluence.ihtsdotools.org/display/DOCECL/7.2+Parsing#FootnoteMarker1-0 "Footnote: Click to return to reference in text") |  [www.coasttocoastresearch.com](http://www.coasttocoastresearch.com)
