...
SNOMED CT Expression Constraints can be automatically validated to ensure that they conform to a variety of rules, including: 
  ...
  * Expression constraints must conform to one of the syntaxes defined in [Chapter 5](5.-Syntax-Specification_28739404.html). Syntactic validation can be performed using an expression parser, as described in [Section 7.2](7.2-Parsing_28739420.html); 
  ...
  * All concept references used to refer to attribute names must be a descendant of [ 246061005 | Attribute|](http://snomed.info/id/246061005 "246061005 | Attribute |") ; 

  * All concept references to which a memberOf function is applied must be a descendant of [ 900000000000455006 | Reference set|](http://snomed.info/id/900000000000455006 "900000000000455006 | Reference set |") ; 
