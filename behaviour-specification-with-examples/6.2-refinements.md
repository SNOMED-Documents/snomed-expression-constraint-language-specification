...
## Attributes <img src="../.gitbook/assets/Screenshot 2025-09-24 at 17.38.47.png" alt="Included in ECL Core" data-size="line">
...
## Attribute Constraint Operators <img src="../.gitbook/assets/Screenshot 2025-09-24 at 17.38.47.png" alt="Included in ECL Core" data-size="line">
...
## Concrete Values <img src="../.gitbook/assets/Screenshot 2025-09-24 at 17.38.47.png" alt="Included in ECL Core" data-size="line">
...
Concrete values of type string and boolean may also be included in an expression constraint, and compared using an 'equal to' (i.e. "=") or 'not equal to' (i.e. "!=") operator. Concrete string values must match the string in the expression constraint exactly.&#x20;

The following expression constraint is satisfied only by products with a product name exactly equal to "PANADOL" using a case sensitive match.
...
## Dotted Attributes <img src="../.gitbook/assets/Screenshot 2025-09-24 at 17.38.47.png" alt="Included in ECL Core" data-size="line">
...
Because all values of `363698007 |Finding site|` must be `< 91723000 | Anatomical structure|` (according to the [SNOMED CT concept model](https://app.gitbook.com/s/uoSxuN6wQMDYcvuq2wNX/readme/concept-model-overview)), this expression constraint can be further simplified to:
...
## Any Attribute Name and Value <img src="../.gitbook/assets/Screenshot 2025-09-24 at 17.38.47.png" alt="Included in ECL Core" data-size="line">
...
[^2]: Please note that the concept 859999999102 is fictitious.
